...
/** 
 * <html><p>This the "BucketSort" class, it extends JFrame. It contains a new window on which
 * the main BucketSort frame is displayed.</p> 
 * <p>This window displays  three options:</p>
 * The Algorithm for Bucket Sort</br>
 * The Demo for Bucket Sort 
 * <br>The Code for Bucket Sort </br>
 * 
 * 
 * 
 * @author Ali&Yara
 *</html>
 */
public class BucketSort extends JFrame implements ActionListener{
	...
	BucketSort(){
		...
		//Our first button leads to the "BucketAlgorithm" window
		...
		//Our second button leads to the "BucketDemo" window
		...
		//Our third button leads to "BucketCode" window
