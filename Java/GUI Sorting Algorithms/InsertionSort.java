...
/** 
 * <html><p>This the "InsertionSort" class, it extends JFrame. It contains a new window on which
 * the main InsertionSort frame is displayed.</p> 
 * <p>This window displays  three options:</p>
 * The Algorithm for Insertion Sort</br>
 * The Demo for Insertion Sort 
 * <br>The Code for Insertion Sort </br>
 * 
 * 
 * 
 * @author Ali&Yara
...
public class InsertionSort extends JFrame implements ActionListener{
	...
	InsertionSort(){
		...
		//Our first button leads to the "InsertionAlgorithm" window
		...
		//Our second button leads to the "InsertionDemo" window
		...
		//Our third button leads to "InsertionCode" window
