...
/** 
 * <html><p>This the "SelectionSort" class, it extends JFrame. It contains a new window on which
 * the main SelectionSort frame is displayed.</p> 
 * <p>This window displays  three options:</p>
 * The Algorithm for Selection Sort</br>
 * The Demo for Selection Sort 
 * <br>The Code for Selection Sort </br>
 * 
 * 
 * 
 * @author Ali&Yara
...
public class SelectionSort extends JFrame implements ActionListener{
	...
	SelectionSort(){
		...
		//Our first button leads to the "SelectionAlgorithm" window
		...
		//Our second button leads to the "SelectionDemo" window
		...
		//Our third button leads to "SelectionCode" window
