...
/** 
 * <html><p>This the "MergeSort" class, it extends JFrame. It contains a new window on which
 * the main MergeSort frame is displayed.</p> 
 * <p>This window displays  three options:</p>
 * The Algorithm for Merge Sort</br>
 * The Demo for Merge Sort 
 * <br>The Code for Merge Sort </br>
 * 
 * 
 * 
 * @author Ali&Yara
...
public class MergeSort extends JFrame implements ActionListener{
	...
	MergeSort(){
		...
		//Our first button leads to the "MergeAlgorithm" window
		...
		//Our second button leads to the "MergeDemo" window
		...
		//Our third button leads to "MergeCode" window
