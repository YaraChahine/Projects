...
/** 
 * <html><p>This the "QuickSort" class, it extends JFrame. It contains a new window on which
 * the main QuickSort frame is displayed.</p> 
 * <p>This window displays  three options:</p>
 * The Algorithm for Quick Sort</br>
 * The Demo for Quick Sort 
 * <br>The Code for Quick Sort </br>
 * 
 * 
 * 
 * @author Ali&Yara
...
public class QuickSort extends JFrame implements ActionListener{
	...
	QuickSort(){
		...
		//Our first button leads to the "QuickAlgorithm" window
		...
		//Our second button leads to the "QuickDemo" window
		...
		//Our third button leads to "QuickCode" window
